...
constexpr const char* const FIRSTNAME = "WIKTOR";
constexpr const char* const SURNAME   = "SATORA";
constexpr const char* const MAIL    = "satora@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "411502";

constexpr const char* const TEACHER_MAIL = "bemaj@agh.edu.pl"; // change if not correct
