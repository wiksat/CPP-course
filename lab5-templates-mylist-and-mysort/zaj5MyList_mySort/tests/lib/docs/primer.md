...
4.  When tests fail, they should provide as much *information* about the problem
    ...
    only stops the current test and continues with the next_. You can also set up
...
googletest always deletes a test fixture before it creates the next_ one.
...
*   Repeats the above steps for the next_ test, until all tests have run.
