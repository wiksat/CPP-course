...
state to its original value before passing control to the next_ test.
...
instantiation of the test suite. The next_ argument is the name of the test
...
googletest catches it, reports it as a test failure, and continues with the next_
