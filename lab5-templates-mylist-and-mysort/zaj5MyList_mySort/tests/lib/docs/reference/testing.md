...
an exception from this function to skip to the next_ test, it must be an
...
caller and makes this function return `NULL` the next_ time.
...
the caller and makes this function return `NULL` the next_ time.
